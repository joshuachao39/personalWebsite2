		...
		return (
			<div style={{width: "100%", height: "100%"}}>
				<div style={{display: "flex", 
			    	...
			    	{/* This is the desk */}
			    	<div style={{width: this.state.width, height: 100, background: "#F4EAD5", position: "absolute", bottom: 0, zIndex: -1}}></div>
			    	...
			    	<img src={mug} style={{position: "absolute", right: 75, bottom: 40}}/>



			    </div>
			    
			    {/* <img style={{width: "100%", height: "100%"}} src={computer}></img> */}
			</div>
		);
	}
}
